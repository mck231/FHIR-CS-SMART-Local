...
{
    private const string _defaultFhirServerUrl = "https://launch.smarthealthit.";
    ...
    public static void DoSomethingWithToken(SmartResponse smartResponse)
    {
        ...
        System.Console.WriteLine($"Read patient: {patient.Name[0].ToString()}");
    }
